...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="RTK GNSS Client (Modular - Curses UI)", formatter_class=argparse.ArgumentDefaultsHelpFormatter
    )
    # Config file
    ...
    module_group.add_argument("--gnss-module", default="lc29h", help="GNSS module type (lc29h, generic)")
    ...
    ntrip_group.add_argument(
        "--ntrip-tls", action="store_true", default=DEFAULT_NTRIP_TLS, help="Enable TLS/SSL for NTRIP connection"
    )

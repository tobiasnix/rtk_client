...
class GnssDevice:
    ...
    def __init__(self, port: str, baudrate: int, state: GnssState, profile: Optional[ModuleProfile] = None):
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            self._serial_port = serial.Serial(
                self._port_name, self._baudrate, timeout=SERIAL_TIMEOUT, write_timeout=SERIAL_TIMEOUT
            )
    ...
    def configure_module(self) -> bool:
        ...
        log_func(
            f"Module configuration complete. {success_count}/{total_sent} commands acknowledged/responded as expected."
        )
